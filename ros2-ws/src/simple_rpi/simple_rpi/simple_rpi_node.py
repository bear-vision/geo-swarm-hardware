...
def create_root() -> py_trees.behaviour.Behaviour:
    ...
    wait_for_5_seconds = py_trees.timers.Timer(name = 'Wait 5 Seconds', duration = 5.0)
    tasks.add_children([turn_off_sprayer, detect_paint, actuate_sprayer, wait_for_5_seconds])
